...
namespace GGD_Hack
{
    public class PluginEventsManager
    {
        ...
        {
            string[] strs = { userId };
            Managers.MainManager.Instance.pluginEventsManager.FELJCGFBKNE(strs, stingerId != null ? stingerId : LocalPlayer.Instance.Player.stingerId);
        ...
        */
        ...
        public static void Drag_Body(BodyHandler body)
        {
            ...
            Managers.MainManager.Instance.pluginEventsManager.ILFLDFPKGNP(body);
        }
        ...
        {
            Managers.MainManager.Instance.pluginEventsManager.KELBNLDKGLE(body);
        }
        ...
        {
            Managers.MainManager.Instance.pluginEventsManager.MPLKPOADINK(userId, (AEMEBPDOAPE)roldId);
        }
        ...
        {
            Managers.MainManager.Instance.pluginEventsManager.ECACJJKOHGP(userId, reason);
        }
        ...
        {
            Managers.MainManager.Instance.pluginEventsManager.KFHJANDHNID(enable);
        }
        ...
        {
            Managers.MainManager.Instance.pluginEventsManager.JHNFAGMAGCD(newRoomSettings);
        }
        ...
        {
            Managers.MainManager.Instance.taskEventsManager.FEICBHFKIDN(userId, taskId, s3);
        }

        //E8 ?? ?? ?? ?? 48 8B 15 ?? ?? ?? ?? 48 85 DB 0F 84 C5 0D 00 00
        public static void RevealRoleInternalLink(string userId, int roleId)
        {
            ...
            Managers.MainManager.Instance.pluginEventsManager.FLFGJJPENCG(userId, (AEMEBPDOAPE)roleId);
        }
    }
}
