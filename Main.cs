...
namespace GGD_Hack
{
    public static class BuildInfo
    {
        ...
        public const string Version = "1.6.17"; // Version of the Mod.  (MUST BE SET)
        public const string gameVersion = "2.20.01";//version of the GGD
    ...
    public class GGDHack_Mod : MelonMod
    {
        ...
        private void Init()
        {
            ...
            //强制提示网红死亡信息
            //ForceEnableCelebrityDeath.Init();
            //自动扔掉炸弹
